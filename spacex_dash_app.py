...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(
                                    ...
                                    max=10000, 
                                    step=1000,
                                    marks={i: str(i) for i in range(0, 10001, 1000)},  # Label marks at intervals of 1000
                                    value=[min_payload, max_payload]  # Default range from min_payload to max_payload
                                ),
...
def update_scatter_chart(selected_site, selected_payload_range):
    ...
    min_payload_range, max_payload_range = selected_payload_range
    ...
    fig = px.scatter(
        ...
        y='class',  # y-axis: Launch outcome (class)
        ...
        color_continuous_scale='Viridis'  # Optional: color scale for better visualization
    )
